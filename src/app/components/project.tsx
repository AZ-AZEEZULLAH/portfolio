        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              I&apos;ve successfully completed 4 projects that reflect the skills and
              ...
              HTML, CSS, and JavaScript. Guessin-game: A fun and engaging game
              ...
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-white opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed line-clamp-2 text-black">
                    Countdown Timer: Built a countdown timer in python .
                  </p>
                  <Link
                    href={
                      "https://github.com/AZ-AZEEZULLAH/python-in-google-colab/blob/main/time.ipynb"
                    }
                  >
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 cursor-pointer">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-white opacity-0 hover:opacity-100">
                  ...
                  <Link
                    href={
                      "https://github.com/AZ-AZEEZULLAH/CLI-Number-Guessing"
                    }
                  >
                    <p className="leading-relaxed text-red-500 hover:underline">
                      View Project ...
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 cursor-pointer">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-white opacity-0 hover:opacity-100">
                  ...
                  <Link href={"https://github.com/AZ-AZEEZULLAH/02-Assignment"}>
                    <p className="leading-relaxed text-red-500 hover:underline">
                      View Project ...
                    </p>
                  </Link>
            ...
            <div className="lg:w-1/3 sm:w-1/2 p-4 cursor-pointer">
              <div className="flex relative">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-white opacity-0 hover:opacity-100">
                  ...
                  <Link href={"https://github.com/AZ-AZEEZULLAH/AZ-ATM-MACHINE"}>
                    <p className="leading-relaxed text-red-500 hover:underline">
                      View Project ...
                    </p>
                  </Link>
