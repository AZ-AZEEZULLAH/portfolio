...
import AzeezImage from "../public/picture/azeez.jpeg";
        ...
        <div className="container e-mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">
              &quot;My name is Azeezullah, and I am a frontend developer. You can reach
              me at my phone number, 03043566873, or via email at
            ...
            <div className="flex justify-center">
              <button className="inline-flex text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-800 rounded text-lg">
                <Link href={"https://github.com/AZ-AZEEZULLAH/MILESTONE-04/"}>
                  View CV
                </Link>
              </button>
