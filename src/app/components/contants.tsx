          ...
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-gray-300 relative flex flex-wrap py-6 rounded shadow-md">
              <div className="lg:w-1/2 px-6">
                ...
                <p className=" text-black mt-1">Tehsil Thari Mirwah District Khairpur</p>
              </div>
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a className="text-black leading-relaxed">
                  azeezullahnoohpoto@gmail.com
                </a>
                <h2 className="title-font font-semibold text-red-500 tracking-widest text-xs mt-4">
                  PHONE
                </h2>
                <p className="text-black leading-relaxed">03043566873</p>
              </div>
            </div>
          </div>
          <div className="lg:w-1/3 md:w-1/2 bg-gray-500 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                id="name"
                name="name"
                className="w-full bg-white rounded border border-gray-300 focus:border-bg-gray-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
            <div className="relative mb-4">
              <label
            ...
            <button className="text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-800 rounded text-lg">
              Send Message
            </button>
